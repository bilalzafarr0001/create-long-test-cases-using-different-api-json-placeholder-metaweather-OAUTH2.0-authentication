...
describe("post user request", () => {
  let accessToken =
    "007526d9efdbc07e084ff7a6d4cfcc90588fbe20641c00faebf45a7f3b2eaf33";
  let randomText = "";
  let testEmail = "";
  ...
  it.only("create user test", () => {
    ...
    cy.request({
      ...
      body: {
        ...
        gender: "male",
        email: "naveencypress112@gmail.com",
        status: "active",
      },
    })
      .then((res) => {
      ...
      .then((res) => {
        ...
        cy.request({
          ...
          body: {
            ...
            gender: "male",
            email: "naveencypressupdated112@gmail.com",
            status: "inactive",
          },
        }).then((res) => {
          ...
          expect(res.body.data).has.property(
            "email",
            "naveencypressupdated112@gmail.com"
          );
          expect(res.body.data).has.property(
            "name",
